...
export function calculateOffsets(group, gridSize, scatter) {
...
function shiftedRect(rect, offset) {
    return {
        x: rect.x + offset.x,
        y: rect.y + offset.y,
        width: rect.width,
...
function getSeparation(a, b, i, j) {
...
function clampOffset(token, offset, gridSize, scatter) {
